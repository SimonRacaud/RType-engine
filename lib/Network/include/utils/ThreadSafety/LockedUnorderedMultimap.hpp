...
template <class Key, class T, class Hash> iterator<Key, T, Hash> LockedUnorderedMultimap<Key, T, Hash>::begin() noexcept
{
    std::scoped_lock lock(_mutex);
...
template <class Key, class T, class Hash> iterator<Key, T, Hash> LockedUnorderedMultimap<Key, T, Hash>::end() noexcept
{
    std::scoped_lock lock(_mutex);
