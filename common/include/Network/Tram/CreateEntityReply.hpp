...
namespace Tram
{
    ...
    class CreateEntityReply : public Tram::Serializable {
      public:
        ...
        CreateEntityReply(size_t roomId, bool accept, uint32_t networkId, std::string const &ip, size_t port,
            Time timestamp, std::string const &entityType, netVector2f const &position, netVector2f const &velocity);
