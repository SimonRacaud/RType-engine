...
=======
            if (Engine::EngineFactory::getInstance().getComponentManager().hasComponent<Component::Position>(entity)) {
                auto [position] = Engine::EngineFactory::getInstance().getComponentManager().getList<Component::Position>(entity);
