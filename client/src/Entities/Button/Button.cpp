...
)
{
    ...
    renderList.push_back(std::make_unique<TextManager>(vector2D(position.x + 73 * 0.1, position.y + 30 * 0.1), size, ITextManager<renderToolSfml>::color_e::WHITE, text, "asset/font/Code-Bold.ttf"));
    pos.push_back(3);
    pos.push_back(0);
